    ...
    <div className="container">
        <div className="row justify-content-center">
            <div className="col-md-8 text-center">
                <h2 className="text-black h1 site-section-heading text-center">{this.state.text[2].title}</h2>
            </div>
        </div>
    </div>
        ...
        <div>
            <div className="testimonial">
                <blockquote className="mb-5">
                    <p>&ldquo; {this.state.text[2].textmini} &rdquo;</p>
                </blockquote>
